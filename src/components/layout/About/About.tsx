      ...
      <div className="about-container">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="about-description">
            At Bazetwo Barbers, we believe grooming is more than just a routine⣔it's a ritual. We blend modern styling sensibilities with classic barbering techniques to deliver an unparalleled experience tailored specifically to you.
          </motion.p>
